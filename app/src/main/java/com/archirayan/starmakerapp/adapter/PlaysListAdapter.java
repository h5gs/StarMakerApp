...
public class PlaysListAdapter extends RecyclerView.Adapter<PlaysListAdapter.MyViewHolder> {
    private ArrayList<MyPostsList> favorites_arraylist;
    private Context context;

    public PlaysListAdapter(Context context, ArrayList<MyPostsList> favorites_arraylists) {
        this.context = context;
        this.favorites_arraylist = favorites_arraylists;
    }

    @Override
    public PlaysListAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_plays_list, parent, false);

        return new PlaysListAdapter.MyViewHolder(itemView);
    }


    @Override
    public void onBindViewHolder(PlaysListAdapter.MyViewHolder holder, int position)
    {
