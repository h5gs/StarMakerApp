...
public class SongAdapter extends RecyclerView.Adapter<SongAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        str_Likes = getSongLists.get(position).getLikes();
        ...
        if (getSongLists.get(position).getHash_tag().isEmpty()) {
            holder.txt_tags.setVisibility(View.VISIBLE);
            holder.txt_tags.setText(getSongLists.get(position).getHash_tag());
        } else {
            holder.txt_tags.setVisibility(View.GONE);
        }
        txt_likenum.setText(getSongLists.get(position).getLikes());
...
//                }
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public TextView profile_name, txt_levels, txt_tags, txt_st_arnum;
